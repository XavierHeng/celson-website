...
const I18N = {
  ...
  dict: {
    ...
    'contact.hero.sub':                { en:'Need a quote? Want to distribute? Have questions? We\'re here — across 98 countries.', fr:'Besoin d\'un devis ? Vous souhaitez distribuer ? Des questions ? Nous sommes là — dans 98 pays.' },

    /* Betty Card */
    'contact.betty.card_aria':         { en:'Betty\'s contact card',      fr:'Carte de contact de Betty' },
    'contact.betty.photo_alt':         { en:'Betty\'s profile photo',     fr:'Photo de profil de Betty' },
    ...
    'contact.betty.wechat_label':      { en:'WeChat ID',                  fr:'Identifiant WeChat' },
    'contact.betty.location_label':    { en:'Location',                   fr:'Adresse' },
    'contact.betty.copy_hint':         { en:'Copy',                       fr:'Copier' },
    'contact.betty.copy_email_aria':   { en:'Copy email address',         fr:'Copier l\'adresse e-mail' },
    'contact.betty.copy_wa_aria':      { en:'Copy WhatsApp number',       fr:'Copier le numéro WhatsApp' },
    'contact.betty.copy_wc_aria':      { en:'Copy WeChat ID',             fr:'Copier l\'identifiant WeChat' },
    ...
    /* Form */
    'contact.form.title':              { en:'Send Us a Message',          fr:'Envoyez-nous un message' },
    'contact.form.sub':                { en:'Fill in the form below and we\'ll get back to you within 24 hours.', fr:'Remplissez le formulaire ci-dessous et nous vous répondrons dans les 24 heures.' },
    'contact.form.name_label':         { en:'Full Name <span class="req">*</span>',                  fr:'Nom complet <span class="req">*</span>' },
    'contact.form.name_placeholder':   { en:'Your full name',             fr:'Votre nom complet' },
    'contact.form.email_label':        { en:'Email Address <span class="req">*</span>',              fr:'Adresse e-mail <span class="req">*</span>' },
    ...
    'contact.form.country_label':      { en:'Country <span class="req">*</span>',                    fr:'Pays <span class="req">*</span>' },
    'contact.form.country_default':    { en:'Select country',             fr:'Sélectionnez un pays' },
    'contact.form.interest_label':     { en:'I\'m interested in <span class="req">*</span>',         fr:'Je suis intéressé(e) par <span class="req">*</span>' },
    'contact.form.interest_default':   { en:'Select an option',           fr:'Sélectionnez une option' },
    'contact.form.message_label':      { en:'Message <span class="req">*</span>',                    fr:'Message <span class="req">*</span>' },
    'contact.form.message_placeholder':{ en:'Tell us about your project, required quantities, timeline, and any specific questions...', fr:'Parlez-nous de votre projet, des quantités requises, du calendrier et de toute question spécifique...' },
    'contact.form.submit':             { en:'Send Message',               fr:'Envoyer le message' },

    /* Country Options */
    'contact.country.US':   { en:'United States',        fr:'États-Unis' },
    'contact.country.UK':   { en:'United Kingdom',       fr:'Royaume-Uni' },
    'contact.country.AE':   { en:'United Arab Emirates', fr:'Émirats arabes unis' },
    'contact.country.SA':   { en:'Saudi Arabia',         fr:'Arabie saoudite' },
    'contact.country.IN':   { en:'India',                fr:'Inde' },
    'contact.country.NG':   { en:'Nigeria',              fr:'Nigéria' },
    'contact.country.KE':   { en:'Kenya',                fr:'Kenya' },
    'contact.country.ZA':   { en:'South Africa',         fr:'Afrique du Sud' },
    'contact.country.BR':   { en:'Brazil',               fr:'Brésil' },
    'contact.country.MX':   { en:'Mexico',               fr:'Mexique' },
    'contact.country.ID':   { en:'Indonesia',            fr:'Indonésie' },
    'contact.country.PH':   { en:'Philippines',          fr:'Philippines' },
    'contact.country.VN':   { en:'Vietnam',              fr:'Vietnam' },
    'contact.country.TH':   { en:'Thailand',             fr:'Thaïlande' },
    'contact.country.AU':   { en:'Australia',            fr:'Australie' },
    'contact.country.CN':   { en:'China',                fr:'Chine' },
    'contact.country.OTHER':{ en:'Other',                fr:'Autre' },

    /* Interest Options */
    'contact.interest.quote':        { en:'Getting a price quote',     fr:'Obtenir un devis' },
    'contact.interest.sample':       { en:'Requesting product samples',fr:'Demander des échantillons' },
    'contact.interest.distributor':  { en:'Becoming a distributor',    fr:'Devenir distributeur' },
    'contact.interest.partnership':  { en:'Partnership opportunity',   fr:'Opportunité de partenariat' },
    'contact.interest.other':        { en:'Other inquiry',             fr:'Autre demande' },

    /* Toast Messages */
    'contact.toast.copied':    { en:'\u2713 Copied!',                          fr:'\u2713 Copié !' },
    'contact.toast.copy':      { en:'Copy',                                    fr:'Copier' },
    'contact.toast.clipboard': { en:'\u2713 Copied to clipboard',              fr:'\u2713 Copié dans le presse-papiers' },
    'contact.toast.sending':   { en:'Sending...',                              fr:'Envoi en cours...' },
    'contact.toast.sent':      { en:'\u2713 Message sent! We\'ll reply within 24 hours.', fr:'\u2713 Message envoyé ! Nous vous répondrons dans les 24 heures.' },
    'contact.toast.error':     { en:'\u26a0 Network error \u2014 please email us directly: Betty.Mat@foxmail.com', fr:'\u26a0 Erreur réseau \u2014 veuillez nous envoyer un e-mail directement : Betty.Mat@foxmail.com' },
    ...
    /* Category Filters */
    'shop.cat.all':                { en:'All',                fr:'Tout' },
    'shop.cat.gypsum':             { en:'Gypsum Boards',      fr:'Plaques de plâtre' },
    'shop.cat.sheet':              { en:'Sheet Boards',       fr:'Panneaux' },
    'shop.cat.wall':               { en:'Wall Panels',        fr:'Panneaux muraux' },
    'shop.cat.ceiling':            { en:'Ceiling &amp; Framing', fr:'Plafonds &amp; Ossature' },
    'shop.cat.calcium':            { en:'Calcium Silicate',   fr:'Silicate de calcium' },
    'shop.cat.outdoor':            { en:'Outdoor &amp; Decking', fr:'Extérieur &amp; Terrasse' },
    'shop.cat.accessories':        { en:'Accessories',        fr:'Accessoires' },
    'shop.cat.insulation':         { en:'Insulation',         fr:'Isolation' },

    /* Cart Bar */
    'shop.cart_bar.title':        { en:'Cart',               fr:'Panier' },
    'shop.cart_bar.title_prefix': { en:'EXW Reference',      fr:'Réf. EXW' },
    'shop.cart_bar.empty':    { en:'EXW Reference $0',   fr:'Réf. EXW 0 €' },
    'shop.cart_bar.ref':      { en:'reference only',     fr:'référence seulement' },
    'shop.cart_bar.view':     { en:'View Cart \u2192',   fr:'Voir le panier \u2192' },

    /* Cart Popup */
    'shop.cart_popup.title':       { en:'Cart',                  fr:'Panier' },
    'shop.cart_popup.ref_total':   { en:'EXW Reference Total',   fr:'Total de référence EXW' },
    'shop.cart_popup.ref_abbr':    { en:'ref.',                  fr:'réf.' },
    'shop.cart_popup.whatsapp':    { en:'Order via WhatsApp',    fr:'Commander via WhatsApp' },
    ...
    'shop.cart_view.col_product':  { en:'Product',               fr:'Produit' },
    'shop.cart_view.col_spec':     { en:'Specification',         fr:'Spécification' },
    'shop.cart_view.col_qty':      { en:'Qty',                   fr:'Qté' },
    'shop.cart_view.col_price':    { en:'Unit Price',            fr:'Prix unitaire' },
    'shop.cart_view.col_subtotal': { en:'Subtotal',              fr:'Sous-total' },
    'shop.cart_view.remove_title': { en:'Remove',                fr:'Retirer' },
    'shop.cart_view.remove_popup': { en:'Remove from cart',      fr:'Retirer du panier' },
    'shop.cart_view.qty_label':    { en:'qty',                   fr:'qté' },
    'shop.cart_view.remove':       { en:'Remove',                fr:'Retirer' },

    /* Cart Summary */
    'shop.cart_summary.total':     { en:'EXW Reference Total',   fr:'Total de référence EXW' },
    'shop.cart_summary.deposit':   { en:'30% Deposit Required',  fr:'Acompte de 30 % requis' },
    ...
    /* Logistics */
    'shop.logistics.title':    { en:'Shipping &amp; Logistics',  fr:'Expédition &amp; Logistique' },
    'shop.logistics.desc':     { en:'Delivery is included only within <strong>Foshan city limits</strong>. The following costs are <strong>not included</strong> and are the buyer\'s responsibility:', fr:'La livraison est incluse uniquement dans <strong>les limites de la ville de Foshan</strong>. Les frais suivants <strong>ne sont pas inclus</strong> et sont à la charge de l\'acheteur :' },
    'shop.logistics.item1':    { en:'Container loading fees (stuffing charges)', fr:'Frais de chargement du conteneur (frais d\'empotage)' },
    'shop.logistics.item2':    { en:'Freight / shipping to destinations outside Foshan', fr:'Fret / expédition vers des destinations hors Foshan' },
    'shop.logistics.item3':    { en:'Export documentation and customs clearance', fr:'Documents d\'exportation et dédouanement' },
    'shop.logistics.free_loc': { en:'We provide a <strong>free container loading location</strong> in Foshan for your forwarder.', fr:'Nous mettons à disposition un <strong>lieu de chargement de conteneur gratuit</strong> à Foshan pour votre transitaire.' },

    /* Order Section */
    'shop.order.title':    { en:'Confirm Your Order',   fr:'Confirmez votre commande' },
    'shop.order.sub':      { en:'Review your items below, then tap to send your inquiry via WhatsApp. We\'ll confirm pricing within 24 hours.', fr:'Vérifiez vos articles ci-dessous, puis appuyez pour envoyer votre demande via WhatsApp. Nous confirmerons les prix sous 24 heures.' },
    'shop.order.whatsapp': { en:'Order via WhatsApp',   fr:'Commander via WhatsApp' },
    'shop.order.note':     { en:'Tapping this opens WhatsApp with your order pre-filled. We\'ll reply within 24 hours to confirm pricing and logistics.', fr:'En appuyant, WhatsApp s\'ouvre avec votre commande pré-remplie. Nous vous répondrons sous 24 heures pour confirmer les prix et la logistique.' },
    'shop.order.backup':   { en:'* A backup confirmation email is also sent automatically for your records.', fr:'* Un e-mail de confirmation de sauvegarde est également envoyé automatiquement pour vos archives.' },

    /* Product Card */
    'shop.product.add':          { en:'Add',            fr:'Ajouter' },
    'shop.product.in_cart':      { en:'\u2713 In Cart', fr:'\u2713 Dans le panier' },
    'shop.product.add_to_cart':  { en:'Add to Cart',    fr:'Ajouter au panier' },
    'shop.product.best_value':   { en:'\uD83D\uDD25 Best Value', fr:'\uD83D\uDD25 Meilleur rapport qualité-prix' },
    ...
    'shop.wa.more_items':     { en:'_...and ',                        fr:'_...et ' },
    ...
    'shop.wa.fob_note':       { en:'FOB pricing — reply to this chat', fr:'Prix FOB — répondez à ce chat' },
    'shop.wa.add_info':       { en:'_(Please add your company name & contact info)_', fr:'_(Veuillez ajouter le nom de votre entreprise et vos coordonnées)_' },
    'shop.wa.empty_cart':     { en:'Your cart is empty. Add items first.', fr:'Votre panier est vide. Ajoutez d\'abord des articles.' },
    'shop.wa.opening':        { en:'Opening WhatsApp... Your order details are pre-filled. We\'ll confirm within 24 hours.', fr:'Ouverture de WhatsApp... Les détails de votre commande sont pré-remplis. Nous confirmerons sous 24 heures.' },
    ...
    'shop.email.logistics':  { en:'Included: Foshan city limits only. Not included: container loading, freight outside Foshan, export docs. Free loading location provided in Foshan.', fr:'Inclus : limites de la ville de Foshan uniquement. Non inclus : chargement du conteneur, fret hors Foshan, documents d\'exportation. Lieu de chargement gratuit fourni à Foshan.' },
    'shop.email.source':     { en:'WhatsApp one-click checkout', fr:'Paiement en un clic WhatsApp' },

    /* Mega Menu Missing Descs */
    'mega.outdoor.desc':    { en:'WPC Decking, Cladding',        fr:'Terrasse WPC, Bardage' },
    'mega.accessories.desc':{ en:'Screws, Joint Tape, Profiles', fr:'Vis, Bande à joint, Profilés' },
    'mega.tiles.desc':      { en:'Porcelain, Ceramic, Glazed',   fr:'Porcelaine, Céramique, Émaillé' },
    'mega.roofing.desc':    { en:'Metal, Asphalt, Waterproofing',fr:'Métal, Asphalte, Étanchéité' },
    'mega.insulation.label':{ en:'Insulation Materials',          fr:'Matériaux d\'isolation' },
    'mega.insulation.desc': { en:'Rock Wool, XPS, Glass Wool',   fr:'Laine de roche, XPS, Laine de verre' },
  },
