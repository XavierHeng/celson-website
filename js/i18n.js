...
const I18N = {
  ...
  dict: {
    ...
    'home.why.3.title':            { en:'One-Stop Sourcing',       fr:'Approvisionnement unique' },
    ...
    /* ─── Homepage — Stats ─── */
    'home.stats.title':            { en:'Trusted Worldwide',       fr:'Une confiance mondiale' },
    ...
    'about.manufacturing.1.label': { en:'Production Facility',      fr:'Surface de production' },
